                            ...
                            <form className="order__form" id="order">       {/* id= нужен для связки фрмы и кноп Отправить: */}
                                <fieldset className="order__fieldset">
                                        ...
                                        <div className="order__input-group">
                                            <input className="order__input" type="text" name="buyerName" placeholder="Имя" />
                                            <input className="order__input" type="tel" name="buyerPhone" placeholder="Телефон" />
                                        </div>
                                </fieldset> 
                                ...
                                <fieldset className="order__fieldset">
                                        ...
                                        <div className="order__input-group">
                                            <input className="order__input" type="text" name="recipientName" placeholder="Имя" />
                                            <input className="order__input" type="tel" name="recipientPhone" placeholder="Телефон" />
                                        </div>
                                </fieldset> 
                                ...
                                <fieldset className="order__fieldset"> 
                                    <div className="order__payment">
                                        <label className="order__label-radio">          {/* атрибут for не нужен тк поле внутри label: */}
                                            <input className="order__radio" type="radio" name="paymentOnline" value="true" defaultChecked /> Оплата онлайн  {/* вместо cheked=true пишем defaultChecked */}
                                        </label>
                                    </div> 

                                    <div className="order__delivery">
                                        <label htmlFor="delivery"> Доставка завтра </label>  {/* вместо атрбиута for ставим  htmlFor  */}
                                        <input type="hidden" name="deliveryDate" value="10.05" />  {/* скрытое поле:  */}

                                        <div className="order__select-wrapper">
                                            <select className="order__select" name="deliveryTime" id="delivery">   {/* id такое же что и у <label for="delivery">Доставка завтра</label>  */}
